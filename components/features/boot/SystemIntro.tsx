    ...
    <AnimatePresence>
      {visible && (
        ...
        >
            ...
            {phase === "warning" && (
              ...
              >
                ...
                <button
                  ...
                  className="system-intro__alarm-btn site-cta mt-8 w-full px-4 py-3 font-mono text-xs font-black uppercase tracking-widest"
                >
                  [{systemIntro.button}]
                </button>
          ...
          {phase === "warning" && (
            <div
              className="system-intro__noise pointer-events-none absolute inset-0 opacity-[0.04]"
              aria-hidden
            />
          )}
        </motion.div>
