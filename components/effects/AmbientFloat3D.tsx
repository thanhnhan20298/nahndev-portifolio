...
export function AmbientFloat3D({ children, className, preset = "card", disabled }: Props) {
  ...
  return (
    <div
      className={cn("site-ambient-scene site-ambient-scene--contain", className)}
      style={{ perspective: SCENE_PERSPECTIVE }}
    >
      <motion.div
        className="site-ambient-float"
