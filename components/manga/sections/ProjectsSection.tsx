...
import { ProjectCardArt } from "@/components/manga/effects/ProjectCardArt";
import { ProjectLink } from "@/components/manga/projects/ProjectLink";
    ...
    <ProjectLink slug={slug} className="project-card gsap-panel-item group block">
      ...
      >
        <div className="min-w-0">
          ...
          <p className="mt-2 line-clamp-2 text-sm leading-relaxed manga-text-body">{description}</p>
        ...
        <ProjectCardArt variant={artVariant} />
      </InkPanel>
    </ProjectLink>
  );
}
