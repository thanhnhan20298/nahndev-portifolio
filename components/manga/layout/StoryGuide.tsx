...
export function StoryGuide() {
  ...
  return (
    <section className="border-b-4 manga-border-section px-4 py-10 md:px-8 md:py-14">
      <div className="manga-story-block mx-auto max-w-3xl">
          ...
          <InkPanel tone="soft" className="p-6 md:p-10">
            ...
            <div className="mt-6 space-y-5">
              {prologue.paragraphs.map((p) => (
                <p key={p} className="text-sm leading-relaxed manga-text-body md:text-[15px]">
                  {p}
                </p>
              ))}
            </div>
            <div className="mt-8 border-t manga-border-section pt-6">
              <p className="font-label text-[10px] text-muted-label">Reading protocol</p>
              <ol className="mt-3 space-y-1.5 font-mono text-[11px] manga-text-dim md:text-xs">
